...
import {DASHBOARD, CONFIGURATION, SETTINGS} from '../utils/Routes'
          ...
          <ul className="navbar-nav ml-auto">
            <li className="nav-item dropdown active">
              ...
              <div className="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                <a className="dropdown-item cs-pointer" onClick={e => this.navigate(CONFIGURATION)}><i className="far fa-id-card"></i> Configuracion</a>
